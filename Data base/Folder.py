# Creation of a folder in the RESEARCH_PATH environment variable, with the folder name being given by user input
...
# os.environ["RESEARCH_PATH"] = r"C:\Users\Milena\Documents\Projects"
